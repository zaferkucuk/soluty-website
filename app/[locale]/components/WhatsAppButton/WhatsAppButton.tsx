    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#25D366] bg-white shadow-md transition-shadow hover:shadow-lg hover:shadow-[#25D366]/20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366] md:bottom-8 md:right-8"
        >
          <svg
