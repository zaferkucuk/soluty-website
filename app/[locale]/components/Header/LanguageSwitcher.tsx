...
function LocaleButton({ 
  ...
  return (
    <button
      onClick={onClick}
      disabled={isPending}
      className="px-1.5 py-0.5 rounded transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand-primary)] focus-visible:ring-offset-1"
      style={{
